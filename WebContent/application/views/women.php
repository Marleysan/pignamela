...
<body>
  ...
  <div class="navbar-collapse collapse">
    <ul class="nav navbar-nav navbar-left">
        ...
        <li><a href="<?php echo base_url(); ?>browse/openwomen" style="color: #FFFFFF;" onmouseover="this.style.color='#AAAAAA'" onmouseout="this.style.color='#FFFFFF'"><u>Women</u></a></li>
    </ul>
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" align="center" style="margin-bottom: 10px;">
        <img src="<?php echo base_url(); ?>assets/img/Women.png" style="width: 100%;" alt="women_cover">
    </div>

    <div class="row" style="margin-left: auto; margin-right: auto; margin-bottom: 10px;">
        <form action="<?php echo base_url(); ?>browse/filterwomen"  method="POST">
